...
// import { getAllVideos, getTournamentById } from "../../server/server";
// import { useParams } from "react-router-dom";

// const ACCENT = "#E50914"; // red accent
// const SECONDARY = "#3B82F6"; // blue secondary
// const BG = "#0d0d0d"; // section background 
// const FALLBACK =
...
//                                 <div
//                                     className={`absolute left-4 top-4 px-4 py-2 rounded-lg text-xs font-bold text-white ${v.type === "live" ? "bg-red-600" : "bg-blue-600"}`}
//                                 >
//                                     {v.type}
//                                 </div>
