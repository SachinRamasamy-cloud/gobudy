...
//   const navigate = useNavigate(); // optional, for page navigation

//   const navItems = [
//     { name: "Home", icon: "fa-solid fa-house" },
//     { name: "Featured Games", icon: "fa-solid fa-gamepad" },
//     { name: "Tournaments", icon: "fa-solid fa-trophy" },
//     { name: "Best Players", icon: "fa-solid fa-users" },
//     { name: "Top Videos", icon: "fa-solid fa-video" },
//     { name: "Reels", icon: "fa-solid fa-film" },
//     { name: "Join Match", icon: "fa-solid fa-handshake" },
...
//                     ${active === item.name ? "bg-red-600 text-white" : "hover:bg-red-500 hover:text-white"}`}
//                 >
