    ...
    <div className="bg-gray-800 py-6">
      ...
      <div className="flex flex-row items-start md:items-center justify-between py-4 px-6 md:px-10 gap-4">
        ...
        <div className="flex gap-2 sm:gap-4">
          <div
            onClick={() => scroll(-300)}
            className="w-11 h-11 rounded-full bg-gray-900 hover:bg-red-600 flex items-center justify-center hover:scale-110 hover:shadow-[0_0_15px_rgba(255,0,0,0.6)] transition-all duration-200 cursor-pointer"
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 z-30 transition-all duration-300 group-hover:translate-y-[-4px]">
                ...
                <p className="text-sm text-gray-300 flex items-center gap-2">
                  <i className="fa-solid fa-heart text-red-500 text-base drop-shadow-[0_0_4px_rgba(255,0,0,0.8)]"></i>
